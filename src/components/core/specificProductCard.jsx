    ...
    <Link href={`/products/${slug}`}>
      <div className="group relative w-80 shadow-black shadow-sm rounded-2xl hover:scale-105 duration-500">
        ...
        <div className="absolute bottom-0 p-6 w-full">
          <div className="mb-2">
            <span className="inline-block text-xs group-hover:text-black duration-500 font-medium text-neutral-300">
              {title}
            </span>
          </div>
          <h3 className="text-2xl font-semibold text-white mb-2 group-hover:hidden block duration-500">
            {title}
          </h3>
        </div>
      </div>
