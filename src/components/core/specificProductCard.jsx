...
export default function SpecificProductCard({ title, imagePath, Category }) {
    return (
        <div className="group relative w-80 shadow-black shadow-sm rounded-2xl hover:scale-105 duration-500">
            {/* Image with overlay gradient */}
            <div className="relative h-96 overflow-hidden rounded-2xl">
                <img src={imagePath} alt="Card image" className="h-full w-full object-cover" />
                {/* Gradient overlay */}
            ...
            <div className="absolute bottom-0 p-6 w-full">
                <div className="mb-2">
                    <span className="inline-block text-xs group-hover:text-black duration-500 font-medium text-neutral-300">{Category}</span>
                </div>
